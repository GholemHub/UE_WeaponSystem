...
AWeaponSystemCharacter::AWeaponSystemCharacter()
{
	...
	WeaponComponent = CreateDefaultSubobject<UWeaponSystemComponent>(TEXT("WeaponSystemComponent"));

}

//////////////////////////////////////////////////////////////////////////// Input

void AWeaponSystemCharacter::NotifyControllerChanged()
{
...
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		EnhancedInputComponent->BindAction(NextWeaponAction, ETriggerEvent::Started, WeaponComponent, &UWeaponSystemComponent::EquipNewWeapon);
		
		EnhancedInputComponent->BindAction(ShootAction_Start, ETriggerEvent::Started, WeaponComponent, &UWeaponSystemComponent::StartFire);
		EnhancedInputComponent->BindAction(ShootAction_End, ETriggerEvent::Completed, WeaponComponent, &UWeaponSystemComponent::StopFire);
